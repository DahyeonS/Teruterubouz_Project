...
<body>
	<nav class="navbar sticky-top navbar-expand-lg bg-body-tertiary rounded" id="menu">
		<div class="container">
			...
			<ul class="nav" id="login">
				<c:if test="${id == null}">
					<li class="nav-item"><a class="nav-link link-body-emphasis px-2" href="<%=contextPath%>/member/login">로그인</a></li>
					<li class="nav-item"><a class="nav-link link-body-emphasis px-2" href="<%=contextPath%>/member/join">회원가입</a></li>
				</c:if>
				<c:if test="${id != null}">
					<li class="nav-item"><a class="nav-link link-body-emphasis px-2" href="<%=contextPath%>/member/check">${nickname}(${id})님</a></li>
					<li class="nav-item"><a class="nav-link link-body-emphasis px-2" href="#" onclick="logoutCheck();">로그아웃</a></li>
				</c:if>
			</ul>
		</div>
	</nav>
